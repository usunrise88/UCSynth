...
// Сколько кадров ПОДРЯД не удалось выдать (0 = шина в порядке). Ненулевое значение = I2C отвалился:
// картинка замерла, но прошивка жива.
uint32_t ssd1306_flush_fails(void);
