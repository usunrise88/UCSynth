...
LIST:           55 AA 01 03 <crc>
  ...
  ← ... PARAM #4..#30 (голос 3.1–3.4: ADSR, осц, фильтр, lo-fi — см. control.h) ...
  ← LISTEND:    55 AA 03 83 1F00 <crc>                        (count = 31)
...
из **31** параметра (реестр строится динамически — новые параметры GUI/скрипт подхватывают через
