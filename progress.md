...
**Текущий этап:** 0 закрыт ✅ → следующий 1 (звук)
**Статус:** Этап 0 закрыт на железе ✅. 0.1 (каркас), 0.2 (реестр параметров), 0.3 (бинарный протокол) — все проверены на плате: `serialtest.py` прогнал LIST/GET/SET-кламп/STAT/NOTE_ON, ответы совпали с `docs/serial-protocol.md`.
