...
**Текущий этап:** 1 — чистый звук. ✅ 1.1 (синус из minijack на железе) → дальше 1.2
**Статус:** 1.1 закрыт на железе ✅ — синус 440 Гц из minijack, I2S std TX (Core 0) на PCM5102 работает. Дальше 1.2 (аудио-задача + метрики CPU/underruns), затем 1.3 (wavetable-осц).
